      ...
      {menuOpen && (
        <div className="md:hidden" style={{ background: 'rgba(255,255,255,0.97)', borderTop: `1px solid ${BORDER}`, padding: '1.5rem' }}>
          <div className="flex flex-col gap-4">
            ...
            <button className="text-sm font-bold mt-2" style={{ fontFamily: "'Exo 2'", color: BG, background: G, padding: '10px 20px', border: 'none', cursor: 'pointer' }}>
              Let's Talk
            </button>
          </div>
        </div>
          ...
          <div>
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-12"
                ...
                <h3 className="text-2xl font-bold mb-3" style={{ fontFamily: "'Exo 2'", color: TEXT }}>Message Received.</h3>
                <p className="text-sm" style={{ fontFamily: "'DM Sans'", fontWeight: 300, color: MUTED }}>We'll be in touch within 24 hours with your tailored analysis.</p>
              </div>
            ) : (
...
//           <span
//             className="text-sm font-bold tracking-widest uppercase"
//             style={{ fontFamily: "'Exo 2', sans-serif", color: '#02050a', letterSpacing: '0.18em' }}
//           >
...
//           Let's Talk
//           <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
//             <path d="M2 6h8M7 3l3 3-3 3" stroke="#ffffff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
//           </svg>
//         </button>
